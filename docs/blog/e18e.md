...
- The [e18e ESLint plugin](https://github.com/e18e/eslint-plugin), which replaces [eslint-plugin-depend](https://github.com/es-tooling/eslint-plugin-depend) and includes its functionality.
